...
def export(archive_dir):
    css = pkgutil.get_data('slackviewerfiles', 'static/viewer.css').decode('utf-8')
    tmpl = Environment(loader=PackageLoader('slackviewerfiles')).get_template("export_single.html")
