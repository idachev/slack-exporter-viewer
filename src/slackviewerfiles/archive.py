...
from slackviewerfiles.utils.six import to_unicode, to_bytes
...
def extract_archive(filepath):
    ...
    archive_sha = SHA1_file(
        filepath=filepath,
        # Add version of slackviewerfiles to hash as well so we can invalidate the cached copy
        #  if there are new features added
        extra=to_bytes(slackviewerfiles.__version__)
    )
